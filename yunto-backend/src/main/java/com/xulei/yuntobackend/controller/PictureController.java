...
import com.xulei.yuntobackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.xulei.yuntobackend.api.imagesearch.ImageSearchApiFacade;
...
import com.xulei.yuntobackend.manager.auth.annotation.SaSpaceCheckPermission;
import com.xulei.yuntobackend.manager.auth.model.SpaceUserPermissionConstant;
...
import com.xulei.yuntobackend.model.VO.PictureTagCategory;
...
import static com.xulei.yuntobackend.manager.auth.StpKit.SPACE;
...
//    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPage(@RequestBody PictureQueryRequest pictureQueryRequest, HttpServletRequest request) {
        ...
        if (spaceId == null) {
            ...
            boolean hasPermission = SPACE.hasPermission(SpaceUserPermissionConstant.PICTURE_VIEW);
            ThrowUtils.throwIf(!hasPermission, ErrorCode.NO_AUTH_ERROR);
            // 私有空间
            // User loginUser = userService.getLoginUser(request);
